/**
 *    clandro-am sends commands to the Clandro:API app through a unix socket
...
int main(int argc, char* argv[]) {
    if (argc > 2) {
        std::cerr << "clandro-am-socket only expects 1 argument and received " << argc - 1 << std::endl;
        return 1;
    }
